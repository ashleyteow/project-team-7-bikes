...
function scatterplotLine() {
  ...
  // create a x-axis title
    ...
    function brush(g) {   
      ...
      // Highlight the selected circles and handles the visual feedback that the user sees upon brushing.
      function highlight() {
      ...
      // function that handles when brushing is complete, and resets styling back to
      // the way it was before brushing.
      function brushEnd() {
